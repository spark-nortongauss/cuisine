...
export function resolveMenuDisplayTitle(menu?: MenuTitleSource | null, approvedOption?: MenuOptionTitleSource | null) {
  return normalizeMeaningful(menu?.title) ?? resolveOptionDisplayTitle(approvedOption) ?? "Untitled menu";
}
